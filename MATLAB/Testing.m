...
for i = 1:timeSteps
	...
	for u = 1:simSteps
		...
		% Link 1
		v2 = v2 + direction(p2, p1) * (d1_2 / sd1_2 - 1) * k * st;
		v2 = v2 + direction(p2, p3) * (d2_3 / sd2_3 - 1) * k * st;
		
		% Link 2
		v3 = v3 + direction(p3, p2) * (d2_3 / sd2_3 - 1) * k * st;
		v3 = v3 + direction(p3, p4) * (d3_4 / sd3_4 - 1) * k * st;
		
		% Link 3
		v4 = v4 + direction(p4, p3) * (d3_4 / sd3_4 - 1) * k * st;
